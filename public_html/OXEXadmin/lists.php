...
$pagetitle = "Field (Dropdown List) Values";
$subtitle = "Fields";
                  ...
                  <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" data-parsley-validate="" novalidate="">
                     ...
                     <div class="card border-info">
                        <div class="card-header bg-info">
                           <div class="card-title">Add new Field Value</div>
                        </div>

                        <div class="card-body">
                           <div class="form-group">
                              <label class="col-form-label" for="select_val">Field Value</label>
                           ...
                           <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <label class="col-form-label" for="select_type">Field Name</label>
