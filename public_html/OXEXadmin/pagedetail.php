...
if ($done == "done" && ($admintype == 'AT' || $admintype == 'DV')) {  
  ...
  // Update record
  $stmt = $mysqli->prepare("UPDATE pages_tbl SET page_name = ?, metatext = ?, googleTitle = ?, googleDesc = ?, googleKeywords = ?, bannerTitle = ?, bannerTxt = ?, page_title = ?, page_txt1 = ?, page_txt2 = ?, page_txt3 = ?, page_txt4 = ?, page_txt5 = ?, page_txt6 = ?, page_txt7 = ?, page_txt8 = ?, page_txt9 = ?, page_txt10 = ?, page_txt11= ?, page_txt12 = ?, date_modified = ?, google_priority = ?, justification = ? WHERE pid = ? "); 
  $stmt->bind_param("ssssssssssssssssssssisii", $page_name, $metatext, $googleTitle, $googleDesc, $googleKeywords, $bannerTitle, $bannerTxt, $page_title, $page_txt1, $page_txt2, $page_txt3, $page_txt4, $page_txt5, $page_txt6, $page_txt7, $page_txt8, $page_txt9, $page_txt10, $page_txt11, $page_txt12, $today, $google_priority, $justification, $which);
  $stmt->execute();
  $stmt->close();
...
$stmt = $mysqli->prepare("SELECT filename, page_name, metatext, googleTitle, googleDesc, googleKeywords, bannerTitle, bannerTxt, justification, page_title, page_txt1, page_txt2, page_txt3, page_txt4, page_txt5, page_txt6, page_txt7, page_txt8, page_txt9, page_txt10, page_txt11, page_txt12, image, date_added, date_modified, google_priority FROM pages_tbl WHERE pid = ?");
$stmt->bind_param("i", $which);
$stmt->execute();
$stmt->store_result();
$stmt->bind_result($filename, $page_name, $metatext, $googleTitle, $googleDesc, $googleKeywords, $bannerTitle, $bannerTxt, $justification, $page_title, $page_txt1, $page_txt2, $page_txt3, $page_txt4, $page_txt5, $page_txt6, $page_txt7, $page_txt8, $page_txt9, $page_txt10, $page_txt11, $page_txt12, $image, $date_added, $date_modified, $google_priority);
$stmt->fetch();
$stmt->close();
