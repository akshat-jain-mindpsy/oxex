                     ...
                     <div class="card border-info">
                        ...
                        <div class="card-body">
                           <div class="form-group">
                              ...
                              <input class="form-control" type="text" id="panel_title" name="panel_title" value="<?php echo $panel_title ?>" required>
                           </div>
                           <div class="form-group">
                              <label class="col-form-label" for="panel_txt">Text</label>
                              <textarea class="form-control summernote" type="text" id="panel_txt" name="panel_txt" required><?php echo $panel_txt ?></textarea>
                           </div>
                           <div class="form-group">
                              <label class="col-form-label" for="panel_btn_txt">Text for Action Button</label>
                              <input class="form-control" type="text" id="panel_btn_txt" name="panel_btn_txt" value="<?php echo $panel_btn_txt ?>">
                           </div>
                           <div class="form-group">
                              <label class="col-form-label" for="panel_btn_link">Link for Action Button</label>
                              <input class="form-control" type="text" id="panel_btn_link" name="panel_btn_link" value="<?php echo $panel_btn_link ?>">
                           </div>
                           <div class="form-group">
...
$subtitle = "sort_order ?>" min="0" max="999"><span class="form-text">Enter 0 if not to be displayed</span>
               ...
               <div class="col-xl-4">
                <div class="card border-info">
                  ...
                  <div class="card-body">
                    <form action="servicephotoprocess.php" method="post" id="ProcessIcon" name="ProcessIcon" class="form-horizontal" enctype="multipart/form-data">
                      <?PHP
                    ...
                    <div id="ProcessIconOutput">
                      <?PHP
                      if ($image != '') {
                        echo "<p><a href=\"servicedetail.php?which=$which&amp;delicon=delicon\"<span class=\"btn btn-danger\">Delete Image</span></a></p>";
                        echo "<p><img src=\"../services/$image\" width=\"200px\"></p>";
                      }
                      ?>
